...
E0005_FIELDS = (
    "itemurl", "product_title", "product_code", "brand", "description", "specifications",
    "additional_code_1", "additional_code_1_type", "additional_code_2",
    "additional_code_2_type", "additional_code_3", "additional_code_3_type",
    "size_info", "size_availability", "size_stock_counts", "color_info", "material_info",
    "variant_info", "price", "full_price", "promotion_type", "promotion_end_date",
    "ppu", "unit_type", "package_desc", "in_stock", "quantity",
    *(f"category{i}" for i in range(1, 11)),
    "main_image_url", "all_images", "additional_tags", "delivery", "additional_content",
)
